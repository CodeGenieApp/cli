...
@codegenie/cli/1.5.4 darwin-arm64 node-v20.12.2
...
_See code: [src/commands/generate.ts](https://github.com/CodeGenieApp/cli/blob/v1.5.4/src/commands/generate.ts)_
...
_See code: [src/commands/login.ts](https://github.com/CodeGenieApp/cli/blob/v1.5.4/src/commands/login.ts)_
