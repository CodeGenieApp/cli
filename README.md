...
@codegenie/cli/1.3.0 darwin-arm64 node-v20.12.2
...
_See code: [dist/commands/generate.ts](https://github.com/CodeGenieApp/cli/blob/v1.3.0/dist/commands/generate.ts)_
...
_See code: [dist/commands/login.ts](https://github.com/CodeGenieApp/cli/blob/v1.3.0/dist/commands/login.ts)_
